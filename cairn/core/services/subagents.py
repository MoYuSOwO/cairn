...
from cairn.core.events import SubAgentCreated, SubAgentUpdated
from cairn.core.models import AgentTask, cairnDeps
...
class SubAgentService:
    deps: cairnDeps
    event_bus: Any
    agent_factory: Callable[[], Agent[cairnDeps, str]]
