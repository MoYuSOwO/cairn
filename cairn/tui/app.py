...
from cairn.core.events import (
    AskUserRequested,
    SubAgentCreated,
    SubAgentUpdated,
    TodoUpdated,
)
from cairn.core.models import UserCancelledError
from cairn.core.runtime import cairnRuntime, build_runtime
from cairn.tui.ask_user_panel import AskUserPanel
from cairn.tui.chat_input import ChatInput
from cairn.tui.client import ChatClient
from cairn.tui.file_mention_panel import FileMentionPanel
from cairn.tui.widgets import BottomBar, MessagePanel, SubAgentLine, TodoDisplay, ToolCallLine
...
class cairnApp(App):
    ...
    def __init__(self, runtime: cairnRuntime | None = None, server_url: str | None = None):
        super().__init__()
    ...
    def _show_welcome(self) -> None:
        self._append_message("**cairn** - 极简 AI 编程助手\n\n输入问题开始对话，Ctrl+C 退出", role="system")
...
def run_client(server_url: str = "ws://127.0.0.1:8720/ws") -> None:
    cairnApp(server_url=server_url).run()
